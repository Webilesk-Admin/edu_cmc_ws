...
"
        >
          ...
          <div className="w-[100%] flex items-center flex-col justify-center my-[20px] md:my-[40px]">
          ...
          <div className="w-[100%] flex items-center flex-col justify-center gap-[20px] my-[20px] md:my-[40px]">
          ...
          <div className="lg:min-w-[578px] h-[81px] bg-[#f9ab70] text-[#fff] relative flex items-center min-w-[300px] w-[80%] max-w-[578px] justify-center rounded-[10px]">
