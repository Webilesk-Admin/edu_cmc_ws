...
const page = () => {
  return (
    <>
      <div className="login-form h-[100%] min-w-[100%] h-[100%] md:h-[100vh] ">
        <Header Color={"#fff"} />
        <div className=" flex items-center justify-center  h-[100%] lg:pl-[60px] pt-[10px] mt-[60px] md:mt-[0px] md:pt-[100px] ">
