...
import BigIcon from "@/asset/Vector.png";
import SmallIcon from "@/asset/cmc_pymt_success_small_icon.png";
const page = () => {
  return (
    <>
      <div className="">
      <Header  ActiveLink="0" UserType={"user"} Color={""} />
        <div className="flex flex-col gap-[10px] items-center h-[80vh] justify-center mt-[60px] md:mt-[110px]">
          <div className="w-[90%] bg-[#2CB62982] h-[263px] rounded-[24px] max-w-[633px] lg:min-w-[633px] flex flex-col items-center justify-center gap-[5px] ">
